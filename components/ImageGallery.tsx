...
export default function ImageGallery({ images, address, floorplans = [] }: { images: string[], address: string, floorplans?: string[] }) {
  ...
  return (
    <>
      <div className="grid grid-cols-2 gap-2">
        <div className="rounded-xl overflow-hidden bg-stone-200 cursor-pointer" onClick={() => images[0] && open(0)}>
          {images[0] ? (
