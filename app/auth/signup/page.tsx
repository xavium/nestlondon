    ...
    return (
      <main className="min-h-screen bg-[#F5F0EB] flex items-center justify-center px-4">
        <div className="w-full max-w-sm text-center">
          ...
          <h2 className="text-xl font-light text-[#1C2B3A] mb-2">Check your email</h2>
  ...
  return (
    <main className="min-h-screen bg-[#F5F0EB] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSignup} className="bg-white border border-[#E8E2DA] rounded-2xl p-8">
          {error && (
          ...
          <div className="mb-4">
            <label className="block text-sm text-[#4A5568] mb-1.5">Agency name</label>
            <input
              type="text"
              value={agencyName}
