      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          ...
          <Link href="/list/auth?redirect=/list" className="group bg-white border border-[#E8E2DA] rounded-2xl p-7 hover:shadow-lg hover:border-[#D3755A] transition-all no-underline">
            ...
            <h2 className="text-lg font-light text-[#1B2E4B] mb-2" style={{fontFamily:'var(--font-serif),Georgia,serif'}}>Private owner or landlord</h2>
            <p className="text-sm text-[#3D3A38] leading-relaxed mb-4">You own or manage rental properties and want to list them directly on NestLondon.</p>
            <div className="flex flex-col gap-1.5">
              {['Free to list', 'No agent fees', 'Direct tenant enquiries'].map(f => (
          ...
          {/* Letting agent */}
          <Link href="/auth/signup" className="group bg-white border border-[#E8E2DA] rounded-2xl p-7 hover:shadow-lg hover:border-[#1B2E4B] transition-all no-underline">
            ...
            <h2 className="text-lg font-light text-[#1B2E4B] mb-2" style={{fontFamily:'var(--font-serif),Georgia,serif'}}>Letting agency</h2>
            <p className="text-sm text-[#3D3A38] leading-relaxed mb-4">You're a professional letting agent managing listings on behalf of landlords.</p>
            <div className="flex flex-col gap-1.5">
              {['Agency dashboard', 'Manage multiple properties', 'Professional tools'].map(f => (
                <div key={f} className="flex items-center gap-2 text-xs text-[#3D3A38]">
            ...
            <div className="mt-5 text-sm font-medium text-[#1B2E4B] group-hover:underline">Register agency →</div>
          </Link>
        </div>
