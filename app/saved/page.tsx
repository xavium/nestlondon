...
export default async function SavedPage() {
  ...
  const { data: savedProperties } = await supabase
    ...
    .select('id, created_at, listing_id, folder_id, listings(id, address, price, bedrooms, bathrooms, property_type, borough, images, is_active, latitude, longitude, listing_type, description, raw_data)')
    .eq('user_id', user.id)
