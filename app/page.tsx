      ...
      <div className="relative min-h-screen">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center px-6 pt-20 pb-32">
          ...
          <div ref={ref} className="w-full max-w-5xl" style={{fontFamily: "var(--font-sans, Manrope, system-ui)"}}>
            ...
            <button
              type="button"
              onClick={() => document.getElementById('borough-quiz')?.scrollIntoView({ behavior: 'smooth', block: 'start' })}
              className="flex items-center gap-2 text-white text-sm hover:opacity-90 transition-opacity px-5 py-2.5 rounded-full font-medium cursor-pointer"
              ...
              Find your perfect London borough
